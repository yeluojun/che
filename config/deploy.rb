...
set :deploy_to, '/deploy/ruby/rails/'
set :repository, 'git@github.com:yeluojun/che.git'
set :branch, 'master'
...
set :shared_paths, ['config/database.yml', 'config/secrets.yml', 'log'] + shared_directories
